...
const About = () => {
  return (
    <div className='section-about main'>
      ...
      <p>Before studying in the FE Engineering program at Turing, I was a product manager tasked with collaborating with developers to figure out how to translate my end-users' needs into effective technology solutions.</p>
      <p className='about-bold'>Being a software developer has reignited my passion to learn and grow in my career precisely because of the hard-skills it gives me to do what I do best and care about most...building things that solve problems.</p>
