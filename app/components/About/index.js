...
const About = () => {
  return (
    <div className='section-about main'>
      ...
      <h3 className='resume-link'><a href="https://drive.google.com/file/d/0B1LF3i2gTJgNR3p4ZzVZSndYY0E/view?usp=sharing" target='_blank' rel="noopener">Check out my resume </a><img className='icon-arrow' src={require('../../Images/resume-icon.png')} /></h3>
    </div>
  );
}
